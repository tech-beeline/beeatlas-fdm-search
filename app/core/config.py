...
class Settings(BaseSettings):
    ...
    SPRING_RABBITMQ_HOST: str
    SPRING_RABBITMQ_VIRTUAL_HOST: str
    SPRING_RABBITMQ_USERNAME: str | None = None
    SPRING_RABBITMQ_PASSWORD: str | None = None
    TECH_CAPABILITY_QUEUE: str
    RABBITMQ_EXCHANGE: str
    RABBITMQ_ROUTING_KEY: str
    APP_AMBASSADOR_AUTH: bool = True
    INTEGRATION_AUTHSSO_SERVER_URL: str | None = None
